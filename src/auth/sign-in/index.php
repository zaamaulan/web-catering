...
<head>
  ...
  <title>Sign In | YumYumExpress</title>
    ...
    <div class="max-w-5xl mx-10">
      <div class="flex">
        <div class="bg-white px-20 py-16 flex justify-center flex-col w-2/3">
          <div class="mb-6">
            <h1 class="font-extrabold text-5xl uppercase flex justify-center mb-2 text-[#2A2A2A]">Sign In</h1>
            <h1 class="font-medium text-[#8A8A8A] text-md text-center">
              Sign In untuk menikmati kemudahan memesan makanan dan minuman favoritmu
            </h1>
          </div>
          <div><?= $errorEmail ?></div>
          <form action="sign-in.php" method="post" class="w-4/6 mx-auto">
        ...
        <div class="w-[400px]">
          <img src="../../pages/assets/images/sign-in.jpg" alt="login" width="" class="" />
        </div>
      </div>
    </div>
  </div>
