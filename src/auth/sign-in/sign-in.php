        ...
        <div class="bg-white px-20 py-16 flex justify-center flex-col w-2/3">
          ...
          <form action="" method="post" class="w-4/6 mx-auto">
            <div class="flex flex-col mx-auto mb-2">
              ...
              <input type="text" name="username" id="" class="border-[0.5px] border-[#797979] px-2.5 py-2 rounded-md focus:outline-none" required />
            </div>
            <?php
            ...
            <input type="submit" class="bg-[#FC7F27] font-extrabold py-2.5 text-xl rounded-xl text-white w-3/6 flex justify-center mx-auto" value="Sign In" />
          </form>
        </div>
        <div class="w-[400px]">
